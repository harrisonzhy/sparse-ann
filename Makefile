...
all: sparse_rt_search_cpu quantized_search_cpu brute_force_cpu ivf_flat_cpu
...
sparse_rt_search_cpu: $(INCS) $(OBJS) sparse_rt_search_cpu.o kmeans_cpu.o
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(OBJS) sparse_rt_search_cpu.o kmeans_cpu.o -o $@ $(LIBS)
	mv $@ $(BIN)
